...
| `why-the-industry-needs-more-hbcu-voices.jpg` | Client photography — Howard pilot, `Images/DSC05935.jpeg` | Behind the Game |
...
`inside-the-howard-symposium.jpg` is a portrait shot, so it needs this — at default centre the
21:9 hero crops to the subject's legs and misses every face. Landscape shots generally don't
need it. **Check both crops after swapping any image in.**
